...
const Page = () => {
  return (
    <main className='grid grid-rows-12 h-screen p-5'>
      ...
      <Link href='/createaccount' className='font-semibold text-sm mt-3 bg-gradient-to-b from-secondary to-primary rounded-md text-white h-14 grid justify-center items-center'>Lets Get Started</Link>
