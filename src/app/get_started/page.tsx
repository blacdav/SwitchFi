...
const Page = () => {
  return (
    <main className='grid grid-rows-12 h-dvh p-5'>
      <Image src='/assets/Exchange.png' alt='logo' width={800} height={800} className='w-80 h-80 row-span-9 m-auto' />
      ...
      <p className='font-semibold text-sm mt-5 mx-auto'>Already have an account? <span className='text-primary underline'><Link href=''>Log In</Link></span></p>
    </main>
  )
}
